...
return [
    ...
    | de modificar cualquiera de estos mensajes aquí.
    |
    */
    ...
    | Esto permite especificar rápidamente un mensaje de idioma personalizado
    ...
    */
    ...
    | posición de atributo por algo más legible como "Correo electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a que los mensajes
    | sean más expresivos.
    |
    */
